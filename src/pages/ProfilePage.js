...
export class ProfilePage {
  ...
  render() {
    if (!currentUser) return this.renderGuest();
    ...
    this.container.innerHTML = `
      <div class="profile-page">
        ...
        <div class="stats-row">
          <div class="stat"><span>${userData.cart?.length || 0}</span>Cart</div>
          <div class="stat"><span>${userData.coins?.balance || 0}</span>Coins</div>
  ...
  renderGuest() {
    this.container.innerHTML = `<div class="guest-card"><h2>Welcome</h2><button class="google-signin-btn">Sign in with Google</button></div>`;
